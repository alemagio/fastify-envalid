...
declare module 'fastify' {
    interface FastifyInstance {
        ...
        makeValidator: <T>(parser: (input: string) => T, type?: string) => (spec?: Spec<T>) => ValidatorSpec<T>;
    }
}
...
declare const _default: import("fastify").FastifyPluginAsync<Record<string, unknown>, import("http").Server>;
